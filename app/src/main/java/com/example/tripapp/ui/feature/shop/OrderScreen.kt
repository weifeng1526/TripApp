...
fun Navigation() {
    ...
    NavHost(navController = navController, startDestination = "productDetailScreen") {
        composable("productDetailScreen") {
            ProductDetailScreen(navController = navController, productVM = ProductVM(), tabVM = TabVM())
        }
        composable("orderScreen") {
            OrderScreen(navController = navController, tabVM = TabVM())
        }
    }
}
